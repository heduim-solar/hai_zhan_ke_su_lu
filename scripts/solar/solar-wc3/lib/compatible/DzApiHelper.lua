...
function DzApiHelper.KKApiGetServerValueLimitLeft(whichPlayer, key)
    return RequestExtraIntegerData(
        82,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiRequestBackendLogic(whichPlayer, key, groupkey)
    return RequestExtraBooleanData(
        83,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiCheckBackendLogicExists(whichPlayer, key)
    return RequestExtraBooleanData(
        84,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiGetBackendLogicIntResult(whichPlayer, key)
    return RequestExtraIntegerData(
        85,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiGetBackendLogicStrResult(whichPlayer, key)
    return RequestExtraStringData(
        86,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiGetBackendLogicUpdateTime(whichPlayer, key)
    return RequestExtraIntegerData(
        87,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiGetBackendLogicGroup(whichPlayer, key)
    return RequestExtraStringData(
        88,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiRemoveBackendLogicResult(whichPlayer, key)
    return RequestExtraBooleanData(
        89,
        whichPlayer,
        key,
...
function DzApiHelper.KKApiTriggerRegisterBackendLogicUpdata(trig)
    DzTriggerRegisterSyncData(trig, "DZBLU", true)
end
function DzApiHelper.KKApiTriggerRegisterBackendLogicDelete(trig)
    DzTriggerRegisterSyncData(trig, "DZBLD", true)
end
function DzApiHelper.KKApiGetSyncBackendLogic()
    return DzGetTriggerSyncData()
end
function DzApiHelper.KKApiIsGameMode()
    return RequestExtraBooleanData(
        90,
        nil,
        nil,
...
function DzApiHelper.KKApiInitializeGameKey(whichPlayer, setIndex, k, data)
    return RequestExtraBooleanData(
        91,
        whichPlayer,
        ((("[{\"name\":\"" .. data) .. "\",\"key\":\"") .. k) .. "\"}]",
...
function DzApiHelper.KKApiPlayerGUID(whichPlayer)
    return RequestExtraStringData(
        93,
        whichPlayer,
        nil,
...
function DzApiHelper.KKApiIsTaskInProgress(whichPlayer, setIndex, taskstat)
    return RequestExtraIntegerData(
        94,
        whichPlayer,
        nil,
...
function DzApiHelper.KKApiQueryTaskCurrentProgress(whichPlayer, setIndex)
    return RequestExtraIntegerData(
        95,
        whichPlayer,
        nil,
...
function DzApiHelper.KKApiQueryTaskTotalProgress(whichPlayer, setIndex)
    return RequestExtraIntegerData(
        96,
        whichPlayer,
        nil,
...
function DzApiHelper.KKApiIsAchievementCompleted(whichPlayer, id)
    return RequestExtraBooleanData(
        98,
        whichPlayer,
        id,
...
function DzApiHelper.KKApiAchievementPoints(whichPlayer)
    return RequestExtraIntegerData(
        99,
        whichPlayer,
        nil,
